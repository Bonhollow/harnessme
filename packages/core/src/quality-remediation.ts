...
const CHECK_TITLES: Record<string, string> = {
  ...
  "critical-context": "Guide critical paths",
...
function workflowFor(checkId: string): QualityRemediationWorkflow {
  ...
  if (checkId === "semantic-coverage" || checkId === "context-delivery" || checkId === "critical-context" || checkId === "test-linkage") return "features";
